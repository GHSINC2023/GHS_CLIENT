...
import Create from '../../../../components/dashboard/moderator/post/create'
import jwtDecode from 'jwt-decode'


const DatPost = dynamic(() => import("../../../../components/dashboard/moderator/post/data"), {
    ssr: false
})
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.header}>
                <div className={styles.container}>
                    <h2>Dashboard / Moderator / Job Post</h2>
