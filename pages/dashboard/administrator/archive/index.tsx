...
const Archive: FC = () => {
    ...
    const [ end, setEndDate ] = useState(`${new Date(Date.now())}`)
            ...
            <div className={styles.data}>
                {status === "post" ?
                    <table>
                        ...
                        <tbody>
                            {ArchData?.getArchiveByDate.length === 0 ?
                    ...
                    null}
                {
                    status === "endorsed" ? <table>
                        ...
                        <tbody>
                            {ArchData?.getArchiveByDate.length === 0 ? data.getArchivebyType.map(({ archiveID, endorse }: any) => (
                ...
                }
                {
                    status === "applicant" ?
                        <table>
                            ...
                            <tbody>
                                {ArchData?.getArchiveByDate.length === 0 ? data.getArchivebyType.map(({ archiveID, applicants, createdAt }: any) => (
